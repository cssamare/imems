...
public class CategoryView extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        boolean done = CatogaryContraller.create(category);

        if (done) {
            JOptionPane.showMessageDialog(this, "successfully Saved");
        } else {
            JOptionPane.showMessageDialog(this, "Saved Falid");
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        ...
        Category categary = CatogaryContraller.retrieve(catid);
        txtName.setText(categary.getName());
